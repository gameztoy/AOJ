...
from modulos.Cartas import EmitirCarta, ConfirmarCarta, RegistrarRecepcionCarta
...
reporte = Reporte("Smoke de Cartas", "CPMB09.39 Registrar Recepcion de Carta")
...
acciones.abrirAccion("Registrar Recepción de Carta")

# Presionamos Seleccionar Oficio dentro de Registrar Recepción de Carta
confirmarCarta = ConfirmarCarta(app, reporte)
confirmarCarta.presionarSeleccionarOficio()

# Seleccionamos el oficio a Registrar Recepción de Carta
seleccion = SelectOficio(app, reporte)
seleccion.seleccionarOficioBase(numOficio,anioOficio)

# Presionamos aceptar para Registrar Recepción de Carta
registrarRecepcionCarta = RegistrarRecepcionCarta(app,reporte)
registrarRecepcionCarta.presionarAceptar()

# Presionamos salir de Registrar Recepción de Carta
