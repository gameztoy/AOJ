...
reporte = Reporte("Smoke de Cartas", "CPMB09.38 Volver a Confirmar Carta")
...
# Seleccionamos el oficio a confirmar carta - SeleccionarOficioBase realiza la Seleccion de Paso
